    ...
    <body>
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="timeline.php">Profile</a>
                        <a class="dropdown-item" href="#">Pengumuman</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">Hasil Seleksi</a>
                        </div>
				</ul>
			</div>
		</nav>
		<div class="container-fluid container-fluid1">
			<h4 class="mb-lg-5 pb-5">Selamat Datang</h4>
		...
		<div id="pendaftar" class="container-fluid pendaftar">
			<div class="container daftar" style="padding-top: 10px;">
				<h3 class="text-center">Formulir Pendaftaran Presiden dan Wakil Presiden Mahasiswa POLINELA</h3>
				<hr class="col-md-6">
				<div class="row">
					<div class="col-md-6 offset-md-3">
						<form action="" method="post">
							...
							<div class="custom-control custom-radio custom-control-inline">
								<input class="custom-control-input" type="radio" name="angkatan" value="3" id="3">
								<label class="custom-control-label" for="3">
									2021
								</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input class="custom-control-input" type="radio" name="angkatan" value="6" id="6">
								<label class="custom-control-label" for="6">
									2022
								</label>
							</div>
							<label for="file_prestasi">Sertifikat Prestasi :</label>
							<div>
		...
		<div class="container-fluid" style="position: relative; top: 20px;">
			<div class="container">
				<p>Copyright &copy; <?= date("Y"); ?> By Kelompok 1 | D3 Manajemen Informatika</p>
			</div>
		</div>
